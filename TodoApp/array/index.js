...
// const position = fruiteName.indexOf("Apple");
// const position = fruiteName.lastIndexOf("Banana");
// const position = fruiteName.includes("Apple");
...
const answer = numbers.find((val , ind , arr)=>{
    return val > 18;
})
